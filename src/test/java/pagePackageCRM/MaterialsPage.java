...
public void createMaterials() throws InterruptedException
{
	...
	act5.moveToElement(MaterialName).click().sendKeys("Inverter Type 26").perform();
	Thread.sleep(500);
...
ac.moveToElement(nameMaterial).click().sendKeys(" New_Materials 116").perform();
...
ac.moveToElement(nameMaterial).click().sendKeys(" _New module 116").perform();
ac.moveToElement(price).click().sendKeys("2000").perform();
ac.moveToElement(unit).click().sendKeys("mm").perform();
...
ac.moveToElement(nameMaterial).click().sendKeys(" _new inverter 116").perform();
ac.moveToElement(price).click().sendKeys("2000").perform();
ac.moveToElement(unit).click().sendKeys("mm").perform();
...
ac.moveToElement(nameMaterial).click().sendKeys(" _New rail 116").perform();
ac.moveToElement(price).click().sendKeys("2000").perform();
ac.moveToElement(unit).click().sendKeys("mm").perform();
//ac.moveToElement(MaterialDescription).click().sendKeys("Description for matrial").perform();
Thread.sleep(1000);
...
ac.moveToElement(nameMaterial).click().sendKeys(" _New battery 116").perform();
ac.moveToElement(price).click().sendKeys("2000").perform();
ac.moveToElement(unit).click().sendKeys("mm").perform();
//ac.moveToElement(MaterialDescription).click().sendKeys("Description for matrial").perform();
Thread.sleep(1000);
...
ac.moveToElement(nameMaterial).click().sendKeys(" _New ev  charger 116").perform();
ac.moveToElement(price).click().sendKeys("2000").perform();
ac.moveToElement(unit).click().sendKeys("mm").perform();
//ac.moveToElement(MaterialDescription).click().sendKeys("Description for matrial").perform();
Thread.sleep(1000);
...
ac.moveToElement(nameMaterial).click().sendKeys(" _New generatorw 116").perform();
ac.moveToElement(price).click().sendKeys("2000").perform();
ac.moveToElement(unit).click().sendKeys("mm").perform();
//ac.moveToElement(MaterialDescription).click().sendKeys("Description for matrial").perform();
Thread.sleep(1000);
...
ac.moveToElement(nameMaterial).click().sendKeys(" _New attachment 116").perform();
ac.moveToElement(price).click().sendKeys("2000").perform();
ac.moveToElement(unit).click().sendKeys("mm").perform();
//ac.moveToElement(MaterialDescription).click().sendKeys("Description for matrial").perform();
Thread.sleep(1000);
